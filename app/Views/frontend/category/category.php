            ...
            <?php foreach ($getPostShowByCat as $item) : ?>
                ...
                <div class="card ecommerce-card mb-75">
                    ...
                    <div class="card-body">
                        ...
                        <div class="media order-2 my-50">
                            <div class="avatar mr-50">
                                <?= img(PATH_LAZY_LOADING, false, ['class' => 'lazy loading', 'width' => 24, 'height' => 24, 'alt' => esc($item['fullname']), 'data-src' => userShowImage($item['avatar'])]) ?>
                            </div>
                    ...
                    <div class="item-options text-center">
                        ...
                        <a href="<?= route_to('user.post.detail', esc($item['catSlug']), esc($item['slug']), esc($item['id'])) ?>" class="btn btn-primary btn-cart border-0">
                            <span>Đọc Thêm</span>
                        </a>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="alert alert-warning text-center">
                <div class="alert-body">
                    ...
                    <span class="text-capitalize">Danh mục này hiện tại chưa có bài đăng nào.</span>
                </div>
            </div>
        </div>
    </div>

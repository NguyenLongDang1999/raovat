...
var url_delete_item = "<?= route_to('admin.banner.multiDestroy') ?>";
var url_status_item = "<?= route_to('admin.banner.multiStatus') ?>";
var click_mode = 0;
...
if (bannerTable.length) {
    var oTable = bannerTable.DataTable({
        ...
        "sAjaxSource": "<?= route_to('admin.banner.getList') ?>",
        "bDeferRender": true,
        "bFilter": false,
        "bDestroy": true,
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body mt-2">
                    <?= form_open(route_to('admin.banner.getList'), ['id' => 'frmSearch', 'method' => 'GET', 'onsubmit' => 'return false;']) ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="form-row mb-1">
                                <div class="col-md-6 mb-1">
                                    <?= form_label('Tiêu đề Banner', 'search[name]', ['class' => 'text-capitalize']) ?>
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <?= form_dropdown('search[cat_id]', $option, '', ['class' => 'custom-select']) ?>
                                </div>

                                <div class="col-md-6 mb-1">
                                    <?= form_label('Vị Trí', 'search[orders]', ['class' => 'text-capitalize']) ?>
                                    <?= form_dropdown('search[orders]', getOptionOrders(), '', ['class' => 'custom-select']) ?>
                                </div>
                            </div>

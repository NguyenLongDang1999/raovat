...
<script>
    ...
    var url_delete_item = "<?= route_to('admin.post.multiPurgeDestroy') ?>";
    var url_restore_item = "<?= route_to('admin.post.multiRestore') ?>";
    var click_mode = 0;
    ...
    if (postTable.length) {
        var oTable = postTable.DataTable({
            ...
            "sAjaxSource": "<?= route_to('admin.post.getListRecycle') ?>",
            "bDeferRender": true,
            "bFilter": false,
            "bDestroy": true,
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">Danh Sách Thùng Rác Bài Đăng Đã Xóa</h4>
                </div>
                <!--Search Form -->
                        ...
                        <div class="col-12">
                            <div class="form-row mb-1">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <?= form_dropdown('search[status]', getOptionStatusPost(), '', ['class' => 'custom-select']) ?>
                                </div>

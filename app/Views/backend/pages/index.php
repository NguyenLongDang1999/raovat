...
var url_status_item = "<?= route_to('admin.pages.multiStatus') ?>";
var click_mode = 0;
...
if (pagesTable.length) {
    var oTable = pagesTable.DataTable({
        ...
        "sAjaxSource": "<?= route_to('admin.pages.getList') ?>",
        "bDeferRender": true,
        "bFilter": false,
        "bDestroy": true,
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body mt-2">
                    <?= form_open(route_to('admin.pages.getList'), ['id' => 'frmSearch', 'method' => 'GET', 'onsubmit' => 'return false;']) ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="form-row mb-1">
                                <div class="col-md-6 mb-1">
                                    <?= form_label('Tiêu đề Pages', 'search[name]', ['class' => 'text-capitalize']) ?>

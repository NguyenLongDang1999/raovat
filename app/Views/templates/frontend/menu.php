    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border"
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="<?= getMenuUserActive('') ?>"><a class="nav-link d-flex align-items-center"
                        href="<?= route_to('user.home.index')?>">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a
                        class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown"><i
                            data-feather="align-justify"></i><span class="text-capitalize">Danh mục</span></a>

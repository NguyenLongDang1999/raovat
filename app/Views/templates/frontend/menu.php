    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item nav-toggle"><a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse"><i class="d-block d-xl-none text-primary toggle-icon font-medium-4" data-feather="x"></i></a>
                </li>
            </ul>
        </div>
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="<?= getMenuUserActive('') ?>"><a class="nav-link d-flex align-items-center" href="<?= route_to('user.home.index') ?>">
                        <i data-feather="home"></i>
                        <span class="text-capitalize">Trang chủ</span>
                    </a>
                </li>

                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-toggle="dropdown"><i data-feather="align-justify"></i><span class="text-capitalize">Danh mục</span></a>
                    <ul class="dropdown-menu">
                        <li class="<?= getMenuUserActive(route_to('user.category.index')) ?>"><a class="dropdown-item d-flex align-items-center" href="<?= route_to('user.category.index') ?>">
                ...
                <?php $pages = model('Pages'); ?>
                <?php foreach ($pages->getAllPages() as $item) : ?>
                    <li class="<?= getMenuUserActive(route_to('user.pages.index', $item['url'])) ?>"><a class="nav-link d-flex align-items-center" href="<?= route_to('user.pages.index', esc($item['url'])) ?>">

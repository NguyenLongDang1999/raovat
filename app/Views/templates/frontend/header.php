        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="user-nav d-sm-flex d-none"><span
                            class="user-name font-weight-bolder text-capitalize"><?= user()->fullname ?></span><span
                            class="user-status">Admin</span></div><span class="avatar"><?= $img ?><span
                            class="avatar-status-online"></span></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="<?= route_to('user.user.my_profile') ?>">
            ...
            <li class="nav-item ml-1">
                <div class="btn-group">
                    <button class="btn btn-outline-primary dropdown-toggle waves-effect" type="button"
                        id="dropdownMenuButton100" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

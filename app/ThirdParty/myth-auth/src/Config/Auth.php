...
class Auth extends BaseConfig
{
	...
	public $views = [
		...
		'forgot'		  => 'App\Views\frontend\auth\forgot',
		'reset'		   => 'App\Views\frontend\auth\reset',
	 ...
	 * @var string[]
	 */
	public $personalFields = ['fullname', 'avatar', 'phone', 'gender', 'job', 'address', 'birthdate'];
	 ...
	 * @var int
	 */
	public $rememberLength = 365 * 5 * DAY;

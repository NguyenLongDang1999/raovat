                                    ...
                                    <tr>
                                        <td class="sm-px-24" style=" background-color: #ffffff; background-color: rgba(255, 255, 255, 1); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; color: #626262; color: rgba(98, 98, 98, 1);" bgcolor="rgba(255, 255, 255, 1)" align="left">
                                            ...
                                            <p style="margin: 0 0 24px;">
                                                Yêu cầu đặt lại mật khẩu của bạn từ
                                                <span style="font-weight: 600;"><?= base_url() ?></span>
                                            </p>
                                            <p style="margin: 0 0 24px;">
                                                Tài khoản -
                                                <a href="mailto:<?= esc($email) ?>" class="hover-underline" style="color: #7367f0; color: rgba(115, 103, 240, 1); text-decoration: none;"><?= esc($email) ?></a>.
                                            </p>
                                            <p style="margin: 24px 0;">
                                                <span style="font-weight: 600;">Code:</span> <?= $hash ?>
                                            </p>
                                            <p style="margin: 0 0 24px;">Sử dụng mã code được gửi và copy nó vào trong ô code.</p>
                                            <p style="margin: 0 0 24px;">Sử dụng liên kết dưới đây để đặt lại mật khẩu và đăng nhập.</p>
                                            <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td style="mso-padding-alt: 16px 24px;  background-color: #7367f0; background-color: rgba(115, 103, 240, 1); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;" bgcolor="rgba(115, 103, 240, 1)">
                                                        <a href="<?= site_url('dat-lai-mat-khau') . '?token=' . $hash ?>" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; color: #ffffff; color: rgba(255, 255, 255, 1); text-decoration: none;">Đặt Lại Mật Khẩu &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p style="margin: 24px 0;">
                                                <span style="font-weight: 600;">Chú Ý:</span>
                                                Liên kết này có hiệu lực trong vòng 1 giờ kể từ khi được gửi cho bạn và chỉ có thể sử dụng để đặt lại mật khẩu.
                                            </p>
                                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td style="font-family: 'Montserrat',Arial,sans-serif; padding-top: 32px; padding-bottom: 32px;">
                                                        <div style=" background-color: #eceff1; background-color: rgba(236, 239, 241, 1); height: 1px; line-height: 1px;">&zwnj;</div>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p style="margin: 0 0 16px;">
                                                Không chắc vì sao bạn nhận được E-mail này? Vui lòng
                                                <a href="mailto:ninhhoaclub.raovat@gmail.com" class="hover-underline" style="color: #7367f0; color: rgba(115, 103, 240, 1); text-decoration: none;">liên hệ với chúng tôi</a>.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>

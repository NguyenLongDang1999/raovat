                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="margin: 0 0 24px;">
                                                If you did not sign up to PixInvent, please ignore this email or contact
                                                us at
                                            ...
                                            <a href="https://pixinvent.com?verification_url"
                                                style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">https://pixinvent.com?verification_url</a>
                                            <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                                        ...
                                                        <a href="<?= site_url('activate-account') . '?token=' . $hash ?>"
